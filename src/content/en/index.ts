  ...
  legal: {
    ...
    kvkk: {
      ...
      sections: [
        ...
        { heading: `Application Method`, body: `You may submit your requests concerning your rights in writing, in accordance with the “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında Tebliğ”, to info@tercumexpert.com or to the address Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya. Your request will be concluded as soon as possible and, in any event, within thirty days at the latest, depending on its nature.` },
      ],
    },
    privacy: {
      ...
      sections: [
        ...
        { heading: `Your Rights`, body: `You may exercise your rights under the KVKK, including the rights to access, correct and delete your personal data. You may contact us at info@tercumexpert.com regarding your requests.` },
        ...
        { heading: `Contact`, body: `For questions relating to privacy: E-mail: info@tercumexpert.com · Telephone: [TELEFON] · Address: Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya.` },
      ],
    },
    distanceSales: {
      ...
      sections: [
        ...
        { heading: `Cancellation and Refund`, body: `For orders whose performance has not commenced, cancellation requests may be submitted via info@tercumexpert.com; approved refunds are made within a reasonable period using the method by which payment was made. For person-specific services whose performance has commenced or been completed, a refund may not be possible due to the nature of the work.` },
