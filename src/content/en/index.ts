...
export const en: PartialDictionary = {
  ...
  legal: {
    ...
    partnership: {
      seo: { title: "Partner Agreement", description: "Terms and conditions of the TercümExpert partner (referral) programme." },
      ...
      sections: [
        ...
        { heading: "Prohibited Conduct", body: "Spam and unsolicited bulk messaging, misleading advertising, fake or self-referral (including the Partner placing orders through their own account), and conduct constituting unfair competition are prohibited. Such breaches are grounds for cancelling the relevant commissions and terminating the Agreement." },
        { heading: "Use of Brand", body: "The Partner may use TercümExpert’s brand, logo and promotional materials only with TercümExpert’s written approval and within the rules it provides." },
        { heading: "Confidentiality and Personal Data", body: "The parties undertake to protect the confidential information they obtain under the Agreement. The Partner processes the personal data of referred customers solely for the purpose of the programme and in accordance with the applicable data-protection legislation." },
        { heading: "Independent Party", body: "The Partner is an independent party; it is not an employee, representative or agent of TercümExpert and may not make commitments to third parties on TercümExpert’s behalf." },
        { heading: "Term and Termination", body: "The Agreement remains in force until either party gives notice of termination. TercümExpert may terminate the Agreement immediately in the event of a breach of obligations; commissions arising from improper or abusive referrals are not paid. Upon termination, legitimate balances that have been unlocked are paid in accordance with the applicable terms." },
        { heading: "Amendments, Disputes and Effect", body: "TercümExpert may update this Agreement from time to time; the current version is always published on this page. The Agreement is governed by the laws of the Republic of Türkiye. By confirming the application, the Partner declares that they have read and accepted all the terms of the Agreement." },
      ],
    },
  },
  ...
  translator: {
    ...
    jobs: {
      ...
      "trDeleted": "Deleted translator",
      "trBanned": "Banned translator",
  ...
  partnerPanel: {
    ...
    "delPartner": "Deleted partner",
    "banPartner": "Banned partner",
  ...
  adminHub: {
    ...
    bReferred: "Referred",
    bBanned: "Banned",
    "tabDeleted": "Deleted Accounts",
    "tabBanned": "Banned Accounts",
    "delMember": "Deleted member",
    "delCustomer": "Deleted customer",
    "delTranslator": "Deleted translator",
    "delPartner": "Deleted partner",
    "banMember": "Banned member",
    "banCustomer": "Banned customer",
    "banTranslator": "Banned translator",
    "banPartner": "Banned partner",
    "delHint": "Accounts that have been deleted. All their records (orders, translations, partner activity) are preserved.",
    "delNone": "No deleted accounts.",
    "delAt": "Deleted on",
    "banHint": "Banned accounts. All their records are preserved.",
    "banNone": "No banned accounts.",
    filterAll: "All",
    memHint: "All members with an account in the system, except admin.",
    memNone: "No members.",
    trHint: "All translators in the system.",
    trNone: "No translator records.",
    trJoinedRole: "Translator since",
    prtHint: "All partners in the system.",
    prtNone: "No partner records.",
    prtCompany: "Company",
    prtJoinedRole: "Partner since",
    mgHint: "Manage members: ban or delete accounts. Actions require confirmation.",
    mgNone: "No members.",
    banBtn: "Ban",
    unbanBtn: "Unban",
    deleteBtn: "Delete account",
    banConfirm: "Are you sure you want to ban this member? They will not be able to sign in.",
    unbanConfirm: "Are you sure you want to remove this member’s ban?",
    deleteConfirm: "This account's login will be permanently disabled and the account archived. All order, translation and partner records and contact details will be preserved. Continue?",
    confirmYes: "Yes, continue",
    confirmNo: "Cancel",
    actionDone: "Done.",
    actionFail: "Action failed. Please try again.",
    tabChats: "Chatbot Logs",
    tabCustomers: 'Customers',
    tabUploads: 'Uploaded Files',
    loading: 'Loading…',
    loadError: 'Could not load. Please try again.',
    back: 'Back',
    custHint: "All registered customers who have placed at least one order.",
