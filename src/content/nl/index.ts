  ...
  legal: {
    ...
    kvkk: {
      ...
      sections: [
        ...
        { heading: `Wijze van verzoekindiening`, body: `U kunt uw verzoeken met betrekking tot uw rechten schriftelijk indienen, in overeenstemming met de “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında Tebliğ”, via het adres info@tercumexpert.com of op het adres Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya. Uw verzoek wordt, naargelang de aard ervan, zo spoedig mogelijk en uiterlijk binnen dertig dagen afgehandeld.` },
      ],
    },
    privacy: {
      ...
      title: `Privacybeleid`,
      sections: [
        { heading: `Inleiding`, body: `Bij TercümExpert hechten wij belang aan uw privacy. Dit Privacybeleid beschrijft welke gegevens wij, voor welke doeleinden, verzamelen en hoe wij deze beschermen bij de diensten die wij aanbieden via tercumexpert.com. Uitgebreide informatie over de verwerking van persoonsgegevens vindt u in de KVKK-informatieverklaring.` },
        ...
        { heading: `Uw rechten`, body: `U kunt uw rechten in het kader van de KVKK uitoefenen, waaronder het recht op inzage, rectificatie en wissing van uw persoonsgegevens. Voor uw verzoeken kunt u contact met ons opnemen via het adres info@tercumexpert.com.` },
        ...
        { heading: `Contact`, body: `Voor vragen over privacy: E-mail: info@tercumexpert.com · Telefoon: [TELEFON] · Adres: Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya.` },
      ],
    },
    distanceSales: {
      ...
      sections: [
        ...
        { heading: `Annulering en terugbetaling`, body: `Bij bestellingen waarvan de uitvoering nog niet is aangevangen, kunnen annuleringsverzoeken worden ingediend via info@tercumexpert.com; goedgekeurde terugbetalingen worden binnen een redelijke termijn verricht met de methode waarmee de betaling is gedaan. Bij op maat gemaakte diensten waarvan de uitvoering is aangevangen of voltooid, kan terugbetaling gezien de aard van het werk niet mogelijk zijn.` },
