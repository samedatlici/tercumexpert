...
export const nl: PartialDictionary = {
  ...
  partnerPanel: {
    ...
    "delPartner": "Verwijderde partner",
    "banPartner": "Geblokkeerde partner",
  ...
  adminHub: {
    tabMembers: "Leden",
    tabTranslators: "Vertalers",
    tabPartners: "Partners",
    tabManage: "Leden beheren",
    bMember: "Lid",
    bCustomer: "Klant",
    bTranslator: "Vertaler",
    bPartner: "Partner",
    bReferred: "Doorverwezen",
    bBanned: "Geblokkeerd",
    "tabDeleted": "Verwijderde accounts",
    "tabBanned": "Geblokkeerde accounts",
    "delMember": "Verwijderd lid",
    "delCustomer": "Verwijderde klant",
    "delTranslator": "Verwijderde vertaler",
    "delPartner": "Verwijderde partner",
    "banMember": "Geblokkeerd lid",
    "banCustomer": "Geblokkeerde klant",
    "banTranslator": "Geblokkeerde vertaler",
    "banPartner": "Geblokkeerde partner",
    "delHint": "Verwijderde accounts. Alle gegevens (bestellingen, vertalingen, partneractiviteit) blijven bewaard.",
    "delNone": "Geen verwijderde accounts.",
    "delAt": "Verwijderd op",
    "banHint": "Geblokkeerde accounts. Alle gegevens blijven bewaard.",
    "banNone": "Geen geblokkeerde accounts.",
    filterAll: "Alle",
    memHint: "Alle leden met een account in het systeem, behalve de beheerder.",
    memNone: "Geen leden.",
    trHint: "Alle vertalers in het systeem.",
    trNone: "Geen vertalers.",
    trJoinedRole: "Vertaler sinds",
    prtHint: "Alle partners in het systeem.",
    prtNone: "Geen partners.",
    prtCompany: "Bedrijf",
    prtJoinedRole: "Partner sinds",
    mgHint: "Beheer leden: accounts blokkeren of verwijderen. Acties vereisen bevestiging.",
    mgNone: "Geen leden.",
    banBtn: "Blokkeren",
    unbanBtn: "Deblokkeren",
    deleteBtn: "Account verwijderen",
    banConfirm: "Weet u zeker dat u dit lid wilt blokkeren? Het lid kan dan niet meer inloggen.",
    unbanConfirm: "Weet u zeker dat u de blokkering van dit lid wilt opheffen?",
    deleteConfirm: "De login van dit account wordt permanent uitgeschakeld en het account wordt gearchiveerd. Alle bestel-, vertaal- en partnergegevens en contactgegevens blijven bewaard. Doorgaan?",
    confirmYes: "Ja, doorgaan",
    confirmNo: "Annuleren",
    actionDone: "Klaar.",
    actionFail: "Actie mislukt. Probeer het opnieuw.",
    tabChats: "Chatbotlogboeken",
    "tabCustomers": "Klanten",
    "tabUploads": "Geüploade bestanden",
    "loading": "Laden…",
    "loadError": "Laden mislukt. Probeer het opnieuw.",
    "back": "Terug",
    custHint: "Alle geregistreerde klanten die ten minste één bestelling hebben geplaatst.",
  ...
  legal: {
    ...
    partnership: {
      seo: { title: "Partnerovereenkomst", description: "Voorwaarden van het TercümExpert-partnerprogramma (verwijzingsprogramma)." },
      ...
      sections: [
        ...
        { heading: "Verboden gedrag", body: "Spam en ongevraagde bulkberichten, misleidende reclame, valse of zelfverwijzing (waaronder het plaatsen van bestellingen door de Partner via zijn eigen account) en gedrag dat oneerlijke concurrentie vormt, zijn verboden. Dergelijke inbreuken vormen grond voor annulering van de betreffende commissies en beëindiging van de Overeenkomst." },
        { heading: "Gebruik van het merk", body: "De Partner mag het merk, logo en promotiemateriaal van TercümExpert uitsluitend gebruiken met schriftelijke toestemming van TercümExpert en binnen de door haar verstrekte regels." },
        { heading: "Vertrouwelijkheid en persoonsgegevens", body: "De partijen verbinden zich ertoe de vertrouwelijke informatie die zij in het kader van de Overeenkomst verkrijgen te beschermen. De Partner verwerkt de persoonsgegevens van verwezen klanten uitsluitend voor het doel van het programma en in overeenstemming met de toepasselijke wetgeving inzake gegevensbescherming." },
        { heading: "Onafhankelijke partij", body: "De Partner is een onafhankelijke partij; hij is geen werknemer, vertegenwoordiger of agent van TercümExpert en mag namens TercümExpert geen verplichtingen aan derden aangaan." },
        { heading: "Duur en beëindiging", body: "De Overeenkomst blijft van kracht totdat een van de partijen de beëindiging aankondigt. TercümExpert kan de Overeenkomst bij schending van verplichtingen onmiddellijk beëindigen; commissies uit onrechtmatige of frauduleuze verwijzingen worden niet uitbetaald. Bij beëindiging worden vrijgegeven rechtmatige saldi volgens de toepasselijke voorwaarden uitbetaald." },
        { heading: "Wijzigingen, geschillen en werking", body: "TercümExpert kan deze Overeenkomst van tijd tot tijd bijwerken; de actuele versie wordt altijd op deze pagina gepubliceerd. De Overeenkomst wordt beheerst door het recht van de Republiek Türkiye. Door de aanmelding te bevestigen verklaart de Partner alle voorwaarden van de Overeenkomst te hebben gelezen en aanvaard." },
      ],
    },
  },
  ...
  translator: {
    ...
    "jobs": {
      ...
      "trDeleted": "Verwijderde vertaler",
      "trBanned": "Geblokkeerde vertaler",
