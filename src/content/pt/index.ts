...
export const pt: PartialDictionary = {
  ...
  partnerPanel: {
    ...
    "delPartner": "Parceiro eliminado",
    "banPartner": "Parceiro banido",
    ...
    colPartner: "Parceiro",
    colCompany: "Empresa",
    partnerShareLabel: "Parte do parceiro",
    adminNet: "Restante (empresa)",
    fltPartner: "Nome do parceiro",
    fltCompany: "Empresa",
    yourEarning: "O seu ganho",
    tabAllOrders: "Todas as encomendas",
    fltOrderNo: "N.º de encomenda",
    fltDateFrom: "De",
    fltDateTo: "Até",
    custFilter: "Pesquisar por nome",
    custEmpty: "Ainda não angariou nenhum membro. Partilhe a sua ligação de convite.",
    colName: "Nome",
    colEmail: "E-mail",
    colPhone: "Telefone",
    colJoined: "Registo",
    custOrderCount: "Encomendas",
    custTotal: "Montante total",
    ordEmpty: "Não há encomendas nesta fase.",
    colOrderNo: "Encomenda",
    colCustomer: "Cliente",
    colService: "Serviço",
    colLangs: "Idiomas",
    colAmount: "Montante",
    ...
    walPayInfo: "Os seus ganhos são adicionados à sua carteira quando o trabalho é concluído; permanecem bloqueados durante 7 dias e depois ficam disponíveis para levantamento. Os pagamentos ao saldo disponível são efetuados no dia 2 e no dia 17 de cada mês.",
    ...
    tabOrdersNew: "Encomendas recebidas",
    tabOrdersActive: "Em processamento",
    tabOrdersDelivery: "A aguardar entrega",
    tabOrdersDone: "Concluídas",
    tabWallet: "Carteira",
    soon: "Muito em breve.",
    save: "Guardar",
    saved: "Guardado.",
    statusApproved: "Parceiro aprovado",
    ibanVerified: "IBAN verificado",
    ibanNotVerified: "IBAN não verificado",
    ibanReminder: "Introduza o seu IBAN e o titular da conta para poder receber pagamentos.",
    refCodeLabel: "O seu código de convite",
  ...
  adminHub: {
    tabMembers: "Membros",
    tabTranslators: "Tradutores",
    tabPartners: "Parceiros",
    tabManage: "Gerir membros",
    bMember: "Membro",
    bCustomer: "Cliente",
    bTranslator: "Tradutor",
    bPartner: "Parceiro",
    bReferred: "Indicado",
    bBanned: "Banido",
    "tabDeleted": "Contas eliminadas",
    "tabBanned": "Contas banidas",
    "delMember": "Membro eliminado",
    "delCustomer": "Cliente eliminado",
    "delTranslator": "Tradutor eliminado",
    "delPartner": "Parceiro eliminado",
    "banMember": "Membro banido",
    "banCustomer": "Cliente banido",
    "banTranslator": "Tradutor banido",
    "banPartner": "Parceiro banido",
    "delHint": "Contas eliminadas. Todos os seus registos (pedidos, traduções, atividade de parceiro) são preservados.",
    "delNone": "Nenhuma conta eliminada.",
    "delAt": "Data de eliminação",
    "banHint": "Contas banidas. Todos os seus registos são preservados.",
    "banNone": "Nenhuma conta banida.",
    filterAll: "Todos",
    memHint: "Todos os membros com conta no sistema, exceto o administrador.",
    memNone: "Sem membros.",
    trHint: "Todos os tradutores no sistema.",
    trNone: "Sem tradutores.",
    trJoinedRole: "Tradutor desde",
    prtHint: "Todos os parceiros no sistema.",
    prtNone: "Sem parceiros.",
    prtCompany: "Empresa",
    prtJoinedRole: "Parceiro desde",
    mgHint: "Faça a gestão dos membros: banir ou eliminar contas. As ações requerem confirmação.",
    mgNone: "Sem membros.",
    banBtn: "Banir",
    unbanBtn: "Remover banimento",
    deleteBtn: "Eliminar conta",
    banConfirm: "Tem a certeza de que pretende banir este membro? Não conseguirá iniciar sessão.",
    unbanConfirm: "Tem a certeza de que pretende remover o banimento deste membro?",
    deleteConfirm: "O acesso a esta conta será permanentemente desativado e a conta arquivada. Todos os pedidos, traduções e registos de parceiro, bem como os dados de contacto, serão preservados. Continuar?",
    confirmYes: "Sim, continuar",
    confirmNo: "Cancelar",
    actionDone: "Concluído.",
    actionFail: "A ação falhou. Tente novamente.",
    tabChats: "Registos do chatbot",
    "tabCustomers": "Clientes",
    "tabUploads": "Ficheiros carregados",
    "loading": "A carregar…",
    "loadError": "Não foi possível carregar. Tente novamente.",
    "back": "Voltar",
    custHint: "Todos os clientes registados que efetuaram pelo menos uma encomenda.",
  ...
  home: {
    ...
    whatsappMsg: "Olá, gostaria de obter informações sobre o vosso serviço de tradução.",
    seo: {
  ...
  corporate: {
    ...
    formErrors: {
      ...
      company: "O nome da empresa é obrigatório.",

      contactName: "O nome da pessoa de contacto é obrigatório.",

      email: "Introduza um endereço de e-mail válido.",

      need: "Descreva brevemente as suas necessidades (pelo menos 10 caracteres).",

      consent: "É necessário o seu consentimento para continuar.",
  ...
  quote: {
    ...
    whatsappMsg: "Olá, gostaria de obter informações sobre um orçamento.",
    cancelPolicy: "Nota: a sua encomenda pode ser cancelada a partir da sua página de encomenda enquanto um tradutor não começar a trabalhar nela, e o seu pagamento será reembolsado. Assim que um tradutor assumir o trabalho, o cancelamento deixa de ser possível.",
    "areas": {
  ...
  order: {
    ...
    whatsappMsg: "Olá, gostaria de obter informações sobre a minha encomenda #{no}.",
    cancel: {
      eligible: "A sua encomenda ainda está no pool; pode cancelá-la e receber um reembolso enquanto um tradutor não a assumir.",
      button: "Cancelar encomenda",
      error: "Não foi possível cancelar a encomenda. É possível que um tradutor a tenha assumido entretanto. Atualize a página.",
      confirmTitle: "Cancelar encomenda",
      confirmDesc: "Tem a certeza de que pretende cancelar esta encomenda? Esta ação é irreversível; o seu pagamento será reembolsado.",
      keep: "Manter",
      confirmYes: "Sim, cancelar",
  ...
  faq: {
    ...
    whatsappMsg: "Olá, tenho uma pergunta.",
    seo: {
  ...
  legal: {
    ...
    partnership: {
      seo: { title: "Contrato de parceria", description: "Termos e condições do programa de parceria (indicação) da TercümExpert." },
      ...
      sections: [
        ...
        { heading: "Condutas proibidas", body: "São proibidos o spam e o envio de mensagens em massa não solicitadas, a publicidade enganosa, a indicação falsa ou a si próprio (incluindo o Parceiro efetuar encomendas através da sua própria conta) e as condutas que constituam concorrência desleal. Tais infrações constituem motivo para o cancelamento das comissões em causa e a rescisão do Contrato." },
        { heading: "Utilização da marca", body: "O Parceiro só pode utilizar a marca, o logótipo e os materiais promocionais da TercümExpert com a aprovação escrita da TercümExpert e no âmbito das regras por esta fornecidas." },
        { heading: "Confidencialidade e dados pessoais", body: "As partes comprometem-se a proteger as informações confidenciais obtidas ao abrigo do Contrato. O Parceiro trata os dados pessoais dos clientes indicados apenas para a finalidade do programa e em conformidade com a legislação de proteção de dados aplicável." },
        { heading: "Parte independente", body: "O Parceiro é uma parte independente; não é empregado, representante nem agente da TercümExpert e não pode assumir compromissos perante terceiros em nome da TercümExpert." },
        { heading: "Vigência e rescisão", body: "O Contrato mantém-se em vigor até que uma das partes notifique a sua rescisão. A TercümExpert pode rescindir o Contrato de imediato em caso de incumprimento das obrigações; as comissões resultantes de indicações indevidas ou abusivas não são pagas. Em caso de rescisão, os saldos legítimos desbloqueados são pagos em conformidade com as condições aplicáveis." },
        { heading: "Alterações, litígios e produção de efeitos", body: "A TercümExpert pode atualizar o presente Contrato periodicamente; a versão em vigor é sempre publicada nesta página. O Contrato rege-se pela lei da República da Türkiye. Ao confirmar a candidatura, o Parceiro declara ter lido e aceite todos os termos do Contrato." },
      ],
    },
  },
  ...
  translator: {
    ...
    "jobs": {
      ...
      "trDeleted": "Tradutor eliminado",
      "trBanned": "Tradutor banido",
