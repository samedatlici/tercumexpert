...
export const pt: PartialDictionary = {
  ...
  legal: {
    ...
    privacy: {
      ...
      sections: [
        { heading: `Introdução`, body: `Na TercümExpert, damos importância à sua privacidade. A presente Política de Privacidade explica quais as informações que recolhemos, para que finalidades e de que forma as protegemos nos serviços que prestamos através de tercumexpert.com. Para informações pormenorizadas sobre o tratamento de dados pessoais, pode consultar o Aviso de Informação KVKK.` },
        ...
        { heading: `Os Seus Direitos`, body: `Pode exercer os direitos que lhe são conferidos pela KVKK, incluindo o acesso, a retificação e o apagamento dos seus dados pessoais. Para os seus pedidos, pode contactar-nos através do endereço info@tercumexpert.com.` },
        ...
        { heading: `Contacto`, body: `Para questões relacionadas com a privacidade: Correio eletrónico: info@tercumexpert.com · Telefone: [TELEFON] · Morada: Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya.` },
      ],
    },
    distanceSales: {
      ...
      sections: [
        ...
        { heading: `Cancelamento e Reembolso`, body: `Nas encomendas cuja execução ainda não tenha sido iniciada, os pedidos de cancelamento podem ser apresentados através de info@tercumexpert.com; os reembolsos considerados procedentes são efetuados, num prazo razoável, pelo mesmo método utilizado no pagamento. Nos serviços personalizados cuja execução já se tenha iniciado ou tenha sido concluída, o reembolso pode não ser possível devido à natureza do trabalho.` },
