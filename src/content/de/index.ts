...
export const de: PartialDictionary = {
  ...
  partnerPanel: {
    ...
    "delPartner": "Gelöschter Partner",
    "banPartner": "Gesperrter Partner",
    ...
    fltDateFrom: "Von",
    fltDateTo: "Bis",
    custFilter: "Nach Namen suchen",
    custEmpty: "Sie haben noch keine Mitglieder geworben. Teilen Sie Ihren Einladungslink.",
    colName: "Name",
    colEmail: "E-Mail",
    colPhone: "Telefon",
    colJoined: "Registriert",
    custOrderCount: "Bestellungen",
    custTotal: "Gesamtbetrag",
    ordEmpty: "Keine Bestellungen in dieser Phase.",
    ...
    walPayInfo: "Ihre Einnahmen werden nach Abschluss des Auftrags Ihrem Guthaben gutgeschrieben; sie bleiben 7 Tage gesperrt und werden dann auszahlbar. Zahlungen auf das auszahlbare Guthaben erfolgen am 2. und 17. jedes Monats.",
    ...
    tabOrdersNew: "Eingegangene Bestellungen",
    tabOrdersActive: "In Bearbeitung",
    tabOrdersDelivery: "Wartet auf Lieferung",
    tabOrdersDone: "Abgeschlossen",
    tabWallet: "Guthaben",
    soon: "Sehr bald.",
    save: "Speichern",
    saved: "Gespeichert.",
    statusApproved: "Genehmigter Partner",
    ibanVerified: "IBAN bestätigt",
    ibanNotVerified: "IBAN nicht bestätigt",
    ibanReminder: "Geben Sie Ihre IBAN und den Kontoinhaber an, damit Sie Zahlungen erhalten können.",
    refCodeLabel: "Ihr Einladungscode",
  ...
  adminHub: {
    ...
    tabTranslators: "Übersetzer",
    tabPartners: "Partner",
    tabManage: "Mitglieder verwalten",
    bMember: "Mitglied",
    bCustomer: "Kunde",
    bTranslator: "Übersetzer",
    bPartner: "Partner",
    bReferred: "Empfohlen",
    bBanned: "Gesperrt",
    "tabDeleted": "Gelöschte Konten",
    "tabBanned": "Gesperrte Konten",
    "delMember": "Gelöschtes Mitglied",
    "delCustomer": "Gelöschter Kunde",
    "delTranslator": "Gelöschter Übersetzer",
    "delPartner": "Gelöschter Partner",
    "banMember": "Gesperrtes Mitglied",
    "banCustomer": "Gesperrter Kunde",
    "banTranslator": "Gesperrter Übersetzer",
    "banPartner": "Gesperrter Partner",
    "delHint": "Gelöschte Konten. Alle Datensätze (Bestellungen, Übersetzungen, Partneraktivität) bleiben erhalten.",
    "delNone": "Keine gelöschten Konten.",
    "delAt": "Gelöscht am",
    "banHint": "Gesperrte Konten. Alle Datensätze bleiben erhalten.",
    "banNone": "Keine gesperrten Konten.",
    filterAll: "Alle",
    memHint: "Alle Mitglieder mit einem Konto im System, außer dem Administrator.",
    memNone: "Keine Mitglieder.",
    trHint: "Alle Übersetzer im System.",
    trNone: "Keine Übersetzer.",
    trJoinedRole: "Übersetzer seit",
    prtHint: "Alle Partner im System.",
    prtNone: "Keine Partner.",
    prtCompany: "Unternehmen",
    prtJoinedRole: "Partner seit",
    mgHint: "Mitglieder verwalten: Konten sperren oder löschen. Aktionen erfordern eine Bestätigung.",
    mgNone: "Keine Mitglieder.",
    banBtn: "Sperren",
    unbanBtn: "Entsperren",
    deleteBtn: "Konto löschen",
    banConfirm: "Möchten Sie dieses Mitglied wirklich sperren? Es kann sich dann nicht mehr anmelden.",
    unbanConfirm: "Möchten Sie die Sperre dieses Mitglieds wirklich aufheben?",
    deleteConfirm: "Der Zugang zu diesem Konto wird dauerhaft deaktiviert und das Konto archiviert. Alle Bestell-, Übersetzungs- und Partnerdatensätze sowie Kontaktdaten bleiben erhalten. Fortfahren?",
    confirmYes: "Ja, fortfahren",
    confirmNo: "Abbrechen",
    actionDone: "Erledigt.",
    actionFail: "Aktion fehlgeschlagen. Bitte versuchen Sie es erneut.",
    tabChats: "Chatbot-Protokolle",
    "tabCustomers": "Kunden",
    "tabUploads": "Hochgeladene Dateien",
    "loading": "Wird geladen…",
    "loadError": "Laden fehlgeschlagen. Bitte versuchen Sie es erneut.",
    "back": "Zurück",
    custHint: "Alle registrierten Kunden, die mindestens eine Bestellung aufgegeben haben.",
  ...
  legal: {
    ...
    partnership: {
      seo: { title: "Partnervereinbarung", description: "Bedingungen des TercümExpert-Partnerprogramms (Empfehlungsprogramm)." },
      ...
      sections: [
        ...
        { heading: "Verbotene Verhaltensweisen", body: "Spam und unerwünschte Massennachrichten, irreführende Werbung, gefälschte oder Eigenempfehlungen (einschließlich der Aufgabe von Bestellungen durch den Partner über sein eigenes Konto) sowie Verhaltensweisen, die unlauteren Wettbewerb darstellen, sind untersagt. Solche Verstöße sind ein Grund für die Stornierung der betreffenden Provisionen und die Kündigung der Vereinbarung." },
        { heading: "Markennutzung", body: "Der Partner darf Marke, Logo und Werbematerialien von TercümExpert nur mit schriftlicher Zustimmung von TercümExpert und im Rahmen der von ihr bereitgestellten Regeln verwenden." },
        { heading: "Vertraulichkeit und personenbezogene Daten", body: "Die Parteien verpflichten sich, die im Rahmen der Vereinbarung erhaltenen vertraulichen Informationen zu schützen. Der Partner verarbeitet die personenbezogenen Daten vermittelter Kunden ausschließlich zum Zweck des Programms und in Übereinstimmung mit den geltenden Datenschutzvorschriften." },
        { heading: "Unabhängige Partei", body: "Der Partner ist eine unabhängige Partei; er ist kein Mitarbeiter, Vertreter oder Beauftragter von TercümExpert und darf keine Verpflichtungen gegenüber Dritten im Namen von TercümExpert eingehen." },
        { heading: "Laufzeit und Kündigung", body: "Die Vereinbarung bleibt in Kraft, bis eine der Parteien die Kündigung erklärt. TercümExpert kann die Vereinbarung bei Verstoß gegen Pflichten fristlos kündigen; Provisionen aus unzulässigen oder missbräuchlichen Vermittlungen werden nicht gezahlt. Im Falle der Kündigung werden freigegebene rechtmäßige Guthaben gemäß den geltenden Bedingungen ausgezahlt." },
        { heading: "Änderungen, Streitigkeiten und Wirksamkeit", body: "TercümExpert kann diese Vereinbarung von Zeit zu Zeit aktualisieren; die aktuelle Fassung wird stets auf dieser Seite veröffentlicht. Die Vereinbarung unterliegt dem Recht der Republik Türkei. Mit der Bestätigung der Bewerbung erklärt der Partner, alle Bedingungen der Vereinbarung gelesen und akzeptiert zu haben." },
      ],
    },
  },
  ...
  translator: {
    ...
    "jobs": {
      ...
      "trDeleted": "Gelöschter Übersetzer",
      "trBanned": "Gesperrter Übersetzer",
