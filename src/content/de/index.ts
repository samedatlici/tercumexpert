  ...
  legal: {
    ...
    kvkk: {
      ...
      sections: [
        ...
        { heading: `Antragsverfahren`, body: `Ihre Anträge in Bezug auf Ihre Rechte können Sie im Einklang mit dem “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında Tebliğ” schriftlich an die E-Mail-Adresse info@tercumexpert.com oder an die Anschrift Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya richten. Ihr Antrag wird je nach seiner Art so schnell wie möglich, spätestens jedoch innerhalb von dreißig Tagen, bearbeitet.` },
      ],
    },
    privacy: {
      ...
      sections: [
        { heading: `Einleitung`, body: `Bei TercümExpert legen wir Wert auf Ihre Privatsphäre. Diese Datenschutzerklärung erläutert, welche Informationen wir bei den über tercumexpert.com angebotenen Leistungen zu welchen Zwecken erheben und wie wir sie schützen. Ausführliche Informationen zur Verarbeitung personenbezogener Daten finden Sie im KVKK-Informationstext.` },
        ...
        { heading: `Ihre Rechte`, body: `Sie können Ihre Rechte nach dem KVKK ausüben, einschließlich des Rechts auf Zugang zu Ihren personenbezogenen Daten sowie auf deren Berichtigung und Löschung. Für Ihre Anträge können Sie sich unter der E-Mail-Adresse info@tercumexpert.com mit uns in Verbindung setzen.` },
        ...
        { heading: `Kontakt`, body: `Bei Fragen zum Datenschutz: E-Mail: info@tercumexpert.com · Telefon: [TELEFON] · Anschrift: Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya.` },
      ],
    },
    distanceSales: {
