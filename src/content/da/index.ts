  ...
  legal: {
    ...
    kvkk: {
      ...
      sections: [
        ...
        { heading: `Fremgangsmåde for henvendelse`, body: `Du kan fremsætte dine anmodninger vedrørende dine rettigheder skriftligt til info@tercumexpert.com eller til adressen Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya i overensstemmelse med “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında Tebliğ”. Din anmodning behandles afhængigt af dens art hurtigst muligt og senest inden for tredive dage.` },
      ],
    },
    privacy: {
      ...
      sections: [
        ...
        { heading: `Dine rettigheder`, body: `Du kan udøve dine rettigheder i henhold til KVKK, herunder retten til indsigt i, berigtigelse og sletning af dine personoplysninger. Du kan kontakte os vedrørende dine anmodninger via info@tercumexpert.com.` },
        ...
        { heading: `Kontakt`, body: `Ved spørgsmål vedrørende privatliv: E-mail: info@tercumexpert.com · Telefon: [TELEFON] · Adresse: Şeyh Şamil Mah. Eylül Sk. No: 2/D, Selçuklu, Konya.` },
      ],
    },
    distanceSales: {
      ...
      sections: [
        ...
        { heading: `Annullering og tilbagebetaling`, body: `For ordrer, hvis udførelse ikke er påbegyndt, kan anmodninger om annullering fremsendes via info@tercumexpert.com; godkendte tilbagebetalinger gennemføres inden for rimelig tid med den betalingsmetode, der er anvendt. For personligt tilpassede ydelser, hvis udførelse er påbegyndt eller fuldført, kan tilbagebetaling som følge af opgavens art ikke være mulig.` },
