...
export const da: PartialDictionary = {
  ...
  legal: {
    ...
    partnership: {
      seo: { title: `Partnerskabsaftale`, description: `Vilkårene for TercümExperts partnerprogram (business partner-program).` },
      title: `Partnerskabsaftale`,
      sections: [
        { heading: `Parter og Genstand`, body: `Nærværende Partnerskabsaftale er indgået mellem på den ene side [ŞİRKET ÜNVANI] (»TercümExpert«) og på den anden side den partner, der ansøger om optagelse i programmet (»Partneren«), med det formål at regulere vilkårene og betingelserne for TercümExperts partnerprogram (henvisningsprogram).` },
        { heading: `Programmets Omfang`, body: `Partneren henviser kunder til TercümExpert gennem sit eget netværk og sine egne kanaler. Såfremt den henviste kunde køber en tjenesteydelse gennem TercümExpert, erhverver Partneren ret til den i nærværende Aftale angivne provision.` },
        { heading: `Provision`, body: `For hver gyldig og godkendt henvisning erhverver Partneren ret til en provision på %20 af det vederlag for tjenesteydelsen, som den henviste kunde har betalt. Provisionssatsen og de tilhørende betingelser kan ændres af TercümExpert med forudgående varsel. Annullerede, tilbagebetalte eller ikke fuldt betalte transaktioner lægges ikke til grund for provisionen.` },
        { heading: `Sporing og Optjening`, body: `Henvisninger tilknyttes gennem det sporingslink eller den QR-kode, der stilles til rådighed for Partneren, eller gennem den af TercümExpert fastsatte metode. Ret til provision opstår alene for transaktioner, der på korrekt vis er tilknyttet ved disse metoder, og for hvilke betaling er fuldført.` },
        { heading: `Betaling`, body: `Optjente provisioner udbetales til den konto, som Partneren har oplyst. Betalingsperioden og de tilhørende betingelser fastsættes særskilt mellem parterne. Skattemæssige forpligtelser vedrørende betalingen er underlagt den gældende lovgivning.` },
        { heading: `Partnerens Forpligtelser`, body: `Partneren forpligter sig til at anvende korrekte og ikke-vildledende oplysninger i sin markedsføring, til at afholde sig fra adfærd, der kan skade TercümExperts brand og omdømme, samt til at overholde den gældende lovgivning.` },
        { heading: `Forbudt Adfærd`, body: `Udsendelse af spam og uønskede masseforsendelser, vildledende reklame samt adfærd, der skaber illoyal konkurrence gennem falske eller selvhenvisninger, er forbudt. Sådan adfærd udgør grundlag for annullering af provisionen og ophævelse af Aftalen.` },
        { heading: `Brug af Brand`, body: `Partneren må alene anvende TercümExperts brand, logo og markedsføringsmateriale inden for rammerne af TercümExperts skriftlige godkendelse og de af TercümExpert fastsatte regler.` },
        { heading: `Fortrolighed`, body: `Parterne forpligter sig til at beskytte de fortrolige oplysninger, de har erhvervet i medfør af nærværende Aftale, og til alene at anvende dem i overensstemmelse med programmets formål.` },
        { heading: `Uafhængig Part`, body: `Partneren er en uafhængig part; Partneren er ikke ansat, repræsentant eller agent for TercümExpert og kan ikke påtage sig forpligtelser over for tredjemand på vegne af TercümExpert.` },
        { heading: `Varighed og Ophævelse`, body: `Aftalen forbliver i kraft, indtil en af parterne meddeler dens ophævelse. TercümExpert kan ophæve Aftalen med øjeblikkelig virkning i tilfælde af misligholdelse af forpligtelserne; i så fald udbetales provisioner hidrørende fra uretmæssige henvisninger ikke.` },
        { heading: `Tvister og Ikrafttræden`, body: `Nærværende Aftale er underlagt lovgivningen i Türkiye Cumhuriyeti. Ved at bekræfte ansøgningen erklærer Partneren at have læst og accepteret Aftalens vilkår.` },
      ],
    },
  },
