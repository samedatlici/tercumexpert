...
export const tr = {
  ...
  legal: {
    ...
    partnership: {
      seo: { title: `İş Ortaklığı Sözleşmesi`, description: `TercümExpert iş ortaklığı (partner) programının şartları.` },
      title: `İş Ortaklığı Sözleşmesi`,
      sections: [
        { heading: `Taraflar ve Konu`, body: `İşbu İş Ortaklığı Sözleşmesi, bir tarafta [ŞİRKET ÜNVANI] (“TercümExpert”) ile diğer tarafta programa başvuran iş ortağı (“Partner”) arasında, TercümExpert iş ortaklığı (yönlendirme) programının şart ve koşullarını düzenlemek amacıyla kurulmuştur.` },
        { heading: `Program Kapsamı`, body: `Partner, kendi ağı ve kanalları aracılığıyla TercümExpert'e müşteri yönlendirir. Yönlendirilen müşterinin TercümExpert üzerinden hizmet satın alması hâlinde Partner, işbu Sözleşme'de belirtilen komisyona hak kazanır.` },
        { heading: `Komisyon`, body: `Partner, geçerli ve onaylanmış her yönlendirme için, yönlendirilen müşterinin ödediği hizmet bedeli üzerinden %20 oranında komisyona hak kazanır. Komisyon oranı ve koşulları, önceden bildirimde bulunmak kaydıyla TercümExpert tarafından güncellenebilir. İptal edilen, iade edilen veya ödemesi tamamlanmayan işlemler komisyona esas alınmaz.` },
        { heading: `Takip ve Hak Ediş`, body: `Yönlendirmeler; Partner'e sağlanan takip bağlantısı, QR kodu veya TercümExpert'in belirlediği yöntemle ilişkilendirilir. Komisyon hak edişi, yalnızca bu yöntemlerle doğru şekilde ilişkilendirilen ve ödemesi tamamlanan işlemler için doğar.` },
        { heading: `Ödeme`, body: `Hak edilen komisyonlar, Partner'in bildirdiği hesaba ödenir. Ödeme dönemi ve koşulları taraflar arasında ayrıca belirlenir. Ödemeye ilişkin vergisel yükümlülükler yürürlükteki mevzuata tabidir.` },
        { heading: `Partner'in Yükümlülükleri`, body: `Partner; tanıtımlarında doğru ve yanıltıcı olmayan bilgi kullanmayı, TercümExpert'in marka ve itibarına zarar verecek davranışlardan kaçınmayı ve yürürlükteki mevzuata uymayı kabul eder.` },
        { heading: `Yasaklı Davranışlar`, body: `Spam ve istenmeyen toplu ileti gönderimi, yanıltıcı reklam, sahte veya kendi kendine yönlendirme ile haksız rekabet oluşturan davranışlar yasaktır. Bu tür davranışlar, komisyonun iptali ve Sözleşme'nin feshi sebebidir.` },
        ...
        { heading: `Gizlilik`, body: `Taraflar, işbu Sözleşme kapsamında edindikleri gizli bilgileri korumayı ve yalnızca programın amacı doğrultusunda kullanmayı taahhüt eder.` },
        ...
        { heading: `Süre ve Fesih`, body: `Sözleşme, taraflardan biri feshini bildirene kadar yürürlükte kalır. TercümExpert, yükümlülüklere aykırılık hâlinde Sözleşme'yi derhâl feshedebilir; bu durumda usulsüz yönlendirmelerden doğan komisyonlar ödenmez.` },
        { heading: `Uyuşmazlık ve Yürürlük`, body: `İşbu Sözleşme Türkiye Cumhuriyeti hukukuna tabidir. Partner, başvuruyu onaylayarak Sözleşme şartlarını okuduğunu ve kabul ettiğini beyan eder.` },
      ],
    },
  },
  ...
  adminHub: {
    ...
    loadError: 'Yüklenemedi. Lütfen tekrar deneyin.',
    back: 'Geri',
    custHint: 'Sistemde kayıtlı tüm müşteriler (tercümanlar hariç).',
