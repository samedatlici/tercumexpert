...
export const tr = {
  ...
  legal: {
    ...
    kvkk: {
      ...
      sections: [
        { heading: `Veri Sorumlusu`, body: `6698 sayılı Kişisel Verilerin Korunması Kanunu (“KVKK”) uyarınca kişisel verileriniz, veri sorumlusu sıfatıyla [ŞİRKET ÜNVANI] (“TercümExpert”) tarafından aşağıda açıklanan kapsamda işlenmektedir. Adres: [ADRES]. E-posta: [E-POSTA]. Telefon: [TELEFON].` },
        ...
        { heading: `Başvuru Yöntemi`, body: `Haklarınıza ilişkin taleplerinizi, “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında Tebliğ”e uygun olarak [E-POSTA] adresine veya [ADRES] adresine yazılı olarak iletebilirsiniz. Talebiniz, niteliğine göre en kısa sürede ve en geç otuz gün içinde sonuçlandırılır.` },
      ],
    },
    privacy: {
      ...
      sections: [
        { heading: `Giriş`, body: `TercümExpert olarak gizliliğinize önem veriyoruz. Bu Gizlilik Politikası, [WEB ADRESİ] üzerinden sunduğumuz hizmetlerde hangi bilgileri, hangi amaçlarla topladığımızı ve nasıl koruduğumuzu açıklar. Kişisel verilerin işlenmesine ilişkin ayrıntılı bilgiye KVKK Aydınlatma Metni’nden ulaşabilirsiniz.` },
        ...
        { heading: `Haklarınız`, body: `Kişisel verilerinize erişme, düzeltme ve silme dâhil KVKK kapsamındaki haklarınızı kullanabilirsiniz. Talepleriniz için [E-POSTA] adresi üzerinden bizimle iletişime geçebilirsiniz.` },
        ...
        { heading: `İletişim`, body: `Gizlilik ile ilgili sorularınız için: E-posta: [E-POSTA] · Telefon: [TELEFON] · Adres: [ADRES].` },
      ],
    },
    distanceSales: {
      ...
      sections: [
        { heading: `Taraflar`, body: `İşbu Mesafeli Satış Sözleşmesi (“Sözleşme”); bir tarafta [ŞİRKET ÜNVANI] (“Satıcı”; adres: [ADRES], e-posta: [E-POSTA], telefon: [TELEFON]) ile diğer tarafta siparişi veren tüketici (“Alıcı”) arasında, 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği uyarınca elektronik ortamda kurulmuştur.` },
        { heading: `Sözleşmenin Konusu`, body: `Sözleşme’nin konusu; Alıcı’nın [WEB ADRESİ] üzerinden elektronik ortamda sipariş ettiği, nitelikleri ve satış bedeli sipariş özetinde belirtilen çeviri, yeminli tercüme, noter ve apostil onayı ile ilgili hizmetlerin sunulmasıdır.` },
        ...
        { heading: `İptal ve İade`, body: `İfasına başlanmamış siparişlerde iptal talepleri [E-POSTA] üzerinden iletilebilir; uygun görülen iadeler, ödemenin yapıldığı yöntemle makul süre içinde gerçekleştirilir. İfasına başlanmış veya tamamlanmış kişiye özel hizmetlerde iade, işin niteliği gereği mümkün olmayabilir.` },
    ...
    partnership: {
      ...
      sections: [
        { heading: "Taraflar ve Konu", body: "İşbu İş Ortaklığı Sözleşmesi, bir tarafta [ŞİRKET ÜNVANI] (“TercümExpert”) ile diğer tarafta programa başvurup onaylanan iş ortağı (“Partner”) arasında, TercümExpert yönlendirme (iş ortaklığı) programının şart ve koşullarını düzenlemek amacıyla kurulmuştur." },
