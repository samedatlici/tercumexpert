...
export const SERVICES = [
  ...
  { id: 'legal', icon: 'Scale', order: 3, homeFeatured: true },
  { id: 'technical', icon: 'Cog', order: 4, homeFeatured: false },
  { id: 'medical', icon: 'HeartPulse', order: 5, homeFeatured: false },
  { id: 'academic', icon: 'GraduationCap', order: 6, homeFeatured: false },
  { id: 'localization', icon: 'Globe', order: 7, homeFeatured: false },
] as const
