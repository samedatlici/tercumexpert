...
/**
 * WhatsApp marka logosu (inline SVG). Lucide marka ikonlarını kaldırdığı için
 * (Facebook vb. gibi) WhatsApp da inline SVG'dir. `currentColor` kullanır:
 * bulunduğu butonun/metnin rengini alır, böylece renk düzeni bozulmaz.
 */
